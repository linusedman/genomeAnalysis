...
#SBATCH -p core
#SBATCH -n 1
#SBATCH -J mummerplot_visualization
#SBATCH -t 01:00:00
...
export RESULT_DIR=/home/edman/genomeAnalysis/analyses/05_synteny_comparison/pacBio/run2/plot
mkdir -p "$RESULT_DIR"
...
# === Create Dotplot with mummerplot ===
mummerplot --fat --filter --png --layout -p assembly_vs_ref "$DELTA_BASENAME"
